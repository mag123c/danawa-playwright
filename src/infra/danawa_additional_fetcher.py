...
class DanawaAdditionalFetcher:
    def __init__(self, page: Page, referer_code: str):
        self.page = page
        self.referer_code = referer_code

    def fetch(self, product_ids: List[str], group_code: str) -> Dict[str, dict]:
        ...
        try:
            response = self.page.request.post(url, data=body, headers=headers, timeout=10000) 
